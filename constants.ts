...
export const PROJECTS: Project[] = [
...
},
  {
    ...
    description: 'A subscription-based SaaS tool that helps marketers generate social media captions. Integrated with OpenAI API and Stripe for monthly billing.',
